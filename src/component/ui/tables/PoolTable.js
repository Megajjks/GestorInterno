...
const PoolTable = () => {
    ...
    const fetchCommitment = async() =>{
        ...
        try{
            const response = await axios.get('https://my-json-server.typicode.com/Megajjks/dbAshokaTest/commitments')
            ...
            setStatus({
                loader:false,
                isError:true,
                message:'Por el momento no se pueden obtener los datos, verifique su conexión'
            })
        }
    }
